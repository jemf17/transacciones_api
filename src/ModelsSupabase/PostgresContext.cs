...
public partial class PostgresContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder){
        //coneccion a la bd 
        Env.Load();
        optionsBuilder.UseNpgsql($"{Environment.GetEnvironmentVariable("SUPABASE_CONNECTION")}");
    }
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdUser).HasName("pendientes_pkey");

            entity.ToTable("pendientes", tb => tb.HasComment("usuarios pendientes para ascender de rol"));

            entity.Property(e => e.IdUser)
                .HasDefaultValueSql("gen_random_uuid()")
                .HasColumnName("id_user");
            entity.Property(e => e.AS).HasColumnName("a/s");
            ...
            entity.HasOne(d => d.IdUserNavigation).WithOne(p => p.Pendiente)
                .HasForeignKey<Pendiente>(d => d.IdUser)
                .HasConstraintName("pendientes_id_user_fkey");
        });
        ...
        modelBuilder.Entity<Profile>(entity =>
        {
            ...
            entity.Property(e => e.Name)
                .HasDefaultValueSql("'\"sin nombre\"'::character varying")
                .HasColumnType("character varying")
                .HasColumnName("name");
            entity.Property(e => e.Perfil)
                .HasDefaultValueSql("'https://jrncdfurtprtrnkiheyq.supabase.co/storage/v1/object/public/profils/img_profiles/profile.jpg'::text")
        ...
        {
            entity.HasKey(e => e.IdUser).HasName("Roles_pkey");
            ...
            entity.HasOne(d => d.IdTypeUserNavigation).WithMany(p => p.Roles)
                .HasForeignKey(d => d.IdTypeUser)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("Roles_id_type_user_fkey");

            entity.HasOne(d => d.IdUserNavigation).WithOne(p => p.RoleNavigation)
                .HasForeignKey<Role>(d => d.IdUser)
                .HasConstraintName("Roles_id_user_fkey");
        });
        ...
        {
            entity.HasKey(e => e.Name).HasName("types_Users_pkey");

            entity.ToTable("types_users");
